...
(function () {
  ...
  const state = {
    ...
    queue: [],
    hasVoted: false,
    // v0.5.6+: when allowVoteChange is true, the user can click another
  ...
  function applyState(data) {
    ...
    el('nowPlayingName').textContent = data.nowPlaying
      ...
      : '—';
    // v0.5.8+: Up Next is shown in all modes. Server computes nextScheduled
    ...
    // Round-advance detection (v0.5.6+): when the server's currentVotingRound
