...
//
// crossOriginEmbedderPolicy is off because it interferes with external
// embedded assets that user templates rely on.
app.use(helmet({
...
// SW v2 (v0.5.28): for HTML navigations, force network revalidation
...
self.addEventListener('fetch', (event) => {
  ...
  // over from before v0.5.28's Cache-Control fix landed.
...
app.get('/', (req, res) => {
  try {
    ...
    // Race tap counts — only queried when race mode is active
