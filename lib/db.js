...
const configMigrations = [
  ...
  // viewer_url: the URL visitors use to open the viewer page. Lite-only —
  // used to generate the dashboard QR code. Main uses public_base_url for
  // audio streaming; Lite has no audio streaming so this is a separate,
  // simpler field that operators set once.
