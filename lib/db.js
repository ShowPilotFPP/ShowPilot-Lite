...
// Seed built-in viewer templates (v0.5.0+)
// Five themed templates ship in public/viewer-templates/. See ShowPilot
// main's db.js for the full rationale — this is a code-for-code parity
// port (non-audio change, both repos per the both-versions-every-time rule).
{
  const fs = require('fs');
  const path = require('path');
